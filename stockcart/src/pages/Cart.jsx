...
const Cart = () => {
  ...
  const fetchData = async () => {
    const response = await fetch("http://localhost:4000/api/view-cart", {
      method: "get",
      credentials: "include",
      headers: {
    ...
    console.log("sassssssd", responseData);
  };
  ...
  const deleteCartProduct = async (id) => {
    const response = await fetch("http://localhost:4000/api/delete-cart", {
      method: "post",
      credentials: "include",
      headers: {
        "content-type": "application/json",
